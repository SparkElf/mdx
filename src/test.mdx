import { Brief } from "src/components/brief.tsx";//不需要加斜杠

<Brief text="Just some advice I would give to my younger self today."/>
...
I also share thoughts and ideas [on Twitter](http://localhost:9999/artical/1) quite regularly. You can also find me on Instagram. See you there!
